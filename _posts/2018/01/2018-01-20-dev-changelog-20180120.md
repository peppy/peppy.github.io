...
I promised more regular updated, but then the change of the year happened (and the rush to getting a new release of lazer out), but more importantly I ran into some issues with the tooling I setup to create these posts.
...
- Add support for variable approach rate [\#1824](https://github.com/ppy/osu/pull/1824) ([Shawdooow](https://github.com/Shawdooow))
